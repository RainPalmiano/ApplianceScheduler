...
if Household_size ==1
apps=appmatrix(AO1,AU1,ST1,D1,PR1,ETF1);

elseif Household_size ==2
apps=appmatrix(AO2,AU2,ST2,D2,PR2,ETF2);

elseif Household_size ==3
apps=appmatrix(AO3,AU3,ST3,D3,PR3,ETF3);

elseif Household_size ==4
apps=appmatrix(AO4,AU4,ST4,D4,PR4,ETF4);
